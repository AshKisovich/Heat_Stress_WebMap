...
map.getView().fit([3488867.919222, 3414260.124896, 4282252.407310, 4033020.288470], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Heat Stress Survey Records</h2>';
        return titleElement;
    })(),
